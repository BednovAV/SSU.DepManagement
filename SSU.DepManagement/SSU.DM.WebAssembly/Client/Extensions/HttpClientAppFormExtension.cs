...
public static class HttpClientAppFormExtension
{
    ...
    public static async Task<CreateRequestTeacherLinkResponse> CreateRequestTeacherLinkAsync(this HttpClient http,
        CreateRequestTeacherLinkRequest request)
    {
        ...
        return await response.Content.ReadFromJsonAsync<CreateRequestTeacherLinkResponse>();
    }
